...
using Orders_1.APIs.Errors;
using Orders_1.APIs.Extensions;
...
{
    protected readonly Orders_1DbContext _context;

    public CustomersServiceBase(Orders_1DbContext context)
    {
        _context = context;
    }
